		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Travel",
									"targetURL": "#travelfreestyle-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"travelfreestyle-display": {
								"semanticObject": "travelfreestyle",
								"action": "display",
								"description": "Travel",
								"title": "Travel",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=travelfreestyle",
									"url": sap.ui.require.toUrl("travelfreestyle")
								}
							}
						}
					}
